                                                            ...
                                                            <li class="control-group">
																...
																<div class="controls">
																	<select id="trafic" multiple="multiple" class="controls selecttwo span11" name="trafic[]" required>
																		...
																		while ($row2 = mysqli_fetch_assoc($res2)) {
																			printf('<option id="%s" value="%s" selected>%s</option>',$row2["id"],$row2["id"],$row2["traf_name"]);
																		}
																		
																		$res3=mysqli_query($db,"Select * from avail_traf where id not in ($traf)");
																		while ($row3 = mysqli_fetch_assoc($res3)) {
																			printf('<option id="%s" value="%s">%s</option>',$row3["id"],$row3["id"],$row3["traf_name"]);
																		}
																	?>		
																	<select>
																...
																<label for="geo" class="control-label">ГЕО</label>
																	<div class="controls">
																			<div class="dropdown span3">
																				<a id="dLabel" role="button" data-toggle="dropdown" class="btn btn-sm btn-default" data-target="#" href="#">
																				Выбрать <span class="caret"></span>
																				</a>
																				<ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu" id="geo-dropdown">
																					<li class="dropdown-submenu">
																						<a tabindex="-1" href="#">Россия</a>
																							<ul class="dropdown-menu">
																								<li class="dropdown-submenu"><a tabindex="-1" href="#">Центр</a>
																									<ul class="dropdown-menu">
																										<li class="dropdown-submenu"><a href="#">Москва и область</a>
																											<ul class="dropdown-menu">
																												<li><a href="#" class="pickup">Город 1</a></li>
																												<li><a href="#" class="pickup">Город 2</a></li>
																												<li><a href="#" class="pickup">Город 3</a></li>
																											</ul>
																										</li>
																										<li class="dropdown-submenu"><a href="#">Белгород и область</a>
																											<ul class="dropdown-menu">
																												<li><a href="#" class="pickup">Город 1</a></li>
																												<li><a href="#" class="pickup">Город 2</a></li>
																												<li><a href="#" class="pickup">Город 3</a></li>
																										...
																										<li><a href="#" class="pickup">Брянск</a>
																									</ul>
																								</li>
																							</ul>
																						</li>
																					<li class="dropdown-submenu">
																						<a tabindex="-1" href="#">СНГ (исключая Россию)</a>
																						</li>
																					<li class="dropdown-submenu">
																						<a tabindex="-1" href="#">Европа</a>
																						</li>
																					<li class="dropdown-submenu">
																						<a tabindex="-1" href="#">Азия</a>
																						</li>
																					...
																					<li class="dropdown-submenu">
																						<a tabindex="-1" href="#">Северная Америка</a>
																						</li>
																					<li class="dropdown-submenu">
																						<a tabindex="-1" href="#">Южная Америка</a>
																						</li>
																					<li class="dropdown-submenu">
																						<a tabindex="-1" href="#">Австралия и Океания</a>
																							<ul class="dropdown-menu">
																		...
																		<input disabled="true" style="cursor: default;" class="span9" id="geo" type="text" name="geo" placeholder="Выбрать регион" required>
																	</div>
																	</li>
															</li>
